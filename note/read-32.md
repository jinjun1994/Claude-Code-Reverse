...
回答：这一站聚焦 worker 到 leader 的权限升级路径。worker 先尝试 classifier，失败后把 ask 上送 leader，并在等待期间维持 pending 状态。

### 反

问题：**如果把这一站的设计反过来，会发生什么？**

回答：如果 worker 自己承担最终审批，swarm 的控制面就会碎裂成多个局部中心。leader 不再是真正的审批汇合点，团队协作也会更难解释。

### 空

问题：**跳出当前文件名，这一站背后更大的问题是什么？**

回答：更大的问题是，多执行体系统里控制权应如何上收。权限只是一个例子，本质上是在讨论“局部执行”和“中心决策”的分工。
