...
回答：这一站是 in-process teammate 的常驻运行时内核，负责 ALS 隔离、权限桥接、idle 等待、消息收发和收尾回收。它说明 in-process teammate 并不是“跑一轮就结束”的轻量任务，而是能长期驻留的 worker。

### 反

问题：**如果把这一站的设计反过来，会发生什么？**

回答：如果 in-process 模式只有 spawn 而没有稳定 runner，它只能胜任一次性子任务。那就无法真正替代 pane/process-based teammate 的持续协作能力。

### 空

问题：**跳出当前文件名，这一站背后更大的问题是什么？**

回答：更大的问题是，共享进程协作者如何既复用资源又保持独立工作节奏。常驻 runner 是这类架构的核心答案。
